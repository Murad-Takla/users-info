        ...
        if (agree) {
            fetch(`http://localhost:3000/users/${user._id}`, {
                ...
                .then(data => {
                    ...
                    // const remainingUser = displayUser.filter(urs => urs._id !== user._id)
    ...
    return (
        <div>
            ...
            <div className='flex flex-col items-center mt-10'>
                <h2 className='mb-2 text-center text-2xl font-bold dark:text-white'>Total Users {users.length}</h2>
                <Link to={`/add-user`}>
                    <button
                ...
                <div className='grid grid-cols-3 gap-5'>
                    {
                        users.map(user => <div className='border p-5 mb-2 shadow-md rounded w-[400px]' key={user._id}>
                            <p>Name:  {user.name}</p>
